...
class ImagingtestsScreen extends StatefulWidget {
  const ImagingtestsScreen({super.key});

  @override
  _ImagingtestsScreenState createState() => _ImagingtestsScreenState();
}

class _ImagingtestsScreenState extends State<ImagingtestsScreen> {
  @override
